...
_HELP = (
    ...
    "`work next <next step / blocker>` and `work draft` prepare a preview. "
    "Confirm privately or explicitly share to the approved project channel shown in the preview; nothing posts automatically.\n"
